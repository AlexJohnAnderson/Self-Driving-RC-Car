...
//Servo min = 150 max  = 280
//Found that it is best to keep servo min at 1ms pwm and max at 2ms frequency of 50Hz.
//This moves the servo between -45deg to 45deg. moves 180deg total
//servo min 1ms/20ms * 4096 = 205 max = 2ms/20ms * 4096 = 409
